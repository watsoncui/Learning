/*
This is the common header file which contains all header files needed.
*/
#ifndef _APUE_H
#define _APUE_H
...
#define is_write_lockable(fdj, offset, whence, len) (lock_test((fd), F_WRLCK, (offset), (whence), (len)) == 0)
